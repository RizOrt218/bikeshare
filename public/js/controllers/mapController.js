 ...
 .controller('MapCtrl',
  ['$http','RouteService', 'UserService', 'PointService', '$scope', '$compile', 'leafletData', 'CommentService', function($http, RouteService, UserService, PointService, $scope, $compile, leafletData, CommentService) {
